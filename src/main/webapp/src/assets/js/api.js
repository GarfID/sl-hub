...
( function(){/*
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
  var g = window, h = document, m = g.location, n = function(){}, q = /\[native code\]/,
    u = function( a, b, c ){return a[ b ] = a[ b ] || c;}, aa = function( a ){
      a = a.sort();
  ...
  var B = function(){
    ...
    if ( A.dpo ) {
      ...
      if ( a = a && ( c.exec( a ) || d.exec( a ) ) ) {
        try {b = decodeURIComponent( a[ 2 ] );} catch (e) {}
      }
    }
    return b;
  }, ba = function( a ){
    ...
    if ( 0 === c ) {
      ...
      for ( var d = 0, e = function(){++d === c && a();}, f = 0; f < c; f++ ) {
        b[ f ]( e );
      }
    }
  }, C = function( a ){return u( u( A, 'H', w() ), a, w() );};
  var D = u( A, 'perf', w() ), F = u( D, 'g', w() ), ca = u( D, 'i', w() );
  u( D, 'r', [] );
  w();
  w();
  var G = function( a, b, c ){
    ...
    b && 0 < b.length && ( b = J( b ), c && 0 < c.length && ( b += '___' + J( c ) ), 28 < b.length && ( b = b.substr( 0,
                                                                                                                      28
    ) + ( b.length - 28 ) ), c = b, b = u( ca, '_p', w() ), u( b, c, w() )[ a ] = ( new Date ).getTime(), G( a,
                                                                                                             '_p',
                                                                                                             c
    ) );
  }, J = function( a ){
  ...
  M.push( [
      ...
      for ( var b in a ) {
        if ( Object.prototype.hasOwnProperty.call( a, b ) ) {
          var c = a[ b ];
          'object' == typeof c ? A[ b ] = u( A, b, [] ).
            concat( c ) : u( A, b, c );
        }
      }
      if ( b = a.u ) {
        a = u( A, 'us', [] ), a.push( b ), ( b = /^https:(.*)$/.exec( b ) ) && a.push( 'http:' + b[ 1 ] );
      }
    },
          ] );
  var da = /^(\/[a-zA-Z0-9_\-]+)+$/,
    ...
    na = function( a, b, c, d ){
      ...
      for ( var d = 0, e = b.length; d < e; ++d ) {
        var f = b[ d ].split( '=' ), l = decodeURIComponent( f[ 0 ] ), k = decodeURIComponent( f[ 1 ] );
      ...
      return null;
    }, ka = /^https?:\/\/[a-z0-9_.-]+\.google(rs)?\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/, ja = /\/cb=/g, ia = /\/\//g,
    oa = function(){
      var a = B();
      if ( !a ) {
  ...
  var R = decodeURI( '%73cript' ), S = /^[-+_0-9\/A-Za-z]+={0,2}$/, T = function( a, b ){
    ...
    var a = A.nonce;
    return void 0 !== a ? a && a === String( a ) && a.match( S ) ? a : A.nonce = null : h.querySelector
                                                                                        ? ( a = h.querySelector(
        'script[nonce]' ) ) ? ( a = a.nonce || a.getAttribute( 'nonce' ) || '', a && a === String( a ) && a.match( S )
                                                                                ? A.nonce = a
                                                                                : A.nonce = null ) : null
                                                                                        : null;
  }, pa = function( a ){
    if ( 'loading' != h.readyState ) {
      V( a );
    } else {
      var b = U(), c = '';
      null !== b && ( c = ' nonce="' + b + '"' );
    ...
    qa( a, c );
    b = a ? a.split( ':' ) : [];
    var d = c.h || oa(), e = u( A, 'ah', w() );
    if ( e[ '::' ] && b.length ) {
      a = [];
      for ( var f = null; f = b.shift(); ) {
        var l = f.split( '.' );
        l = e[ f ] || e[ l[ 1 ] && 'ns:' + l[ 0 ] || '' ] || d;
        var k = a.length && a[ a.length - 1 ] || null, v = k;
    ...
    a = aa( a ) || [];
    var d = b.callback, e = b.config, f = b.timeout, l = b.ontimeout, k = b.onerror, v = void 0;
    ...
    k = u( C( c ), 'r', [] ).
      sort();
    var H = u( C( c ), 'L', [] ).
      sort(), E = [].concat( k ), W = function( a, b ){
      if ( y ) {
        return 0;
      }
      g.clearTimeout( x );
    ...
    if ( p.length ) {
      ...
      r[ t ] = function( a ){
        ...
        0 < t && r[ t - 1 ] ? r[ t ] = function(){b( c );} : b( c );
      };
      if ( p.length ) {
        var I = 'loaded_' + A.I++;
        z[ I ] = function( a ){
  ...
  var X = function( a, b ){
    if ( A.hee && 0 < A.hel ) {
      ...
      try {return a();} catch (c) {throw b && b( c ), c;}
    }
  };
  z.load = function( a, b ){return X( function(){return Z( a, b );} );};
  ...
  callback: window[ 'gapi_onload' ], _c: {
    'jsl': {
      'ci': {
        ...
        'debug': {
          'reportExceptionRate': 0.05, 'forceIm': false, 'rethrowException': false, 'host': 'https://apis.google.com',
        },
        ...
        'iframes': {
          ...
          'plus_circle': {
            'params': {'url': ''}, 'url': ':socialhost:/:session_prefix::se:_/widget/plus/circle?usegapi\u003d1',
          },
          'plus_share': {
            'params': {'url': ''},
          ...
          'rbr_s': {
            'params': {'url': ''}, 'url': ':socialhost:/:session_prefix::se:_/widget/render/recobarsimplescroller',
          },
          ':source:': '3p',
          ...
          'evwidget': {
            'params': {'url': ''}, 'url': ':socialhost:/:session_prefix:_/events/widget?usegapi\u003d1',
          },
          ...
          'plus_followers': {
            'params': {'url': ''}, 'url': ':socialhost:/_/im/_/widget/render/plus/followers?usegapi\u003d1',
          },
          'post': {
            'params': {'url': ''}, 'url': ':socialhost:/:session_prefix::im_prefix:_/widget/render/post?usegapi\u003d1',
          },
          ...
          'rbr_i': {
            'params': {'url': ''}, 'url': ':socialhost:/:session_prefix::se:_/widget/render/recobarinvitation',
          },
          ...
          'visibility': {
            'params': {'url': ''}, 'url': ':socialhost:/:session_prefix:_/widget/render/visibility?usegapi\u003d1',
          },
          'autocomplete': {
            'params': {'url': ''}, 'url': ':socialhost:/:session_prefix:_/widget/render/autocomplete',
          },
          'additnow': {
            'url': 'https://apis.google.com/additnow/additnow.html?usegapi\u003d1', 'methods': [ 'launchurl' ],
          },
          ...
          'ytshare': {
            'params': {'url': ''}, 'url': ':socialhost:/:session_prefix:_/widget/render/ytshare?usegapi\u003d1',
          },
          'plus': {'url': ':socialhost:/:session_prefix:_/widget/render/badge?usegapi\u003d1'},
          'family_creation': {
            'params': {'url': ''}, 'url': 'https://families.google.com/webcreation?usegapi\u003d1\u0026usegapi\u003d1',
          },
